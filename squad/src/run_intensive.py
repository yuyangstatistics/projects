        ...
        with torch.enable_grad(), \
            ...
            for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids in train_loader:
                ...
                progress_bar.set_postfix(epoch=epoch,
                                         ...
                                         BCE=bce_loss.item(),
                                         NLL_BCE=loss_val)
                tbx.add_scalar('train/NLL', nll_loss.item(), step)
                tbx.add_scalar('train/BCE', bce_loss.item(), step)
                tbx.add_scalar('train/NLL_BCE', loss_val, step)
...
def evaluate(model, data_loader, device, eval_file, max_len, use_squad_v2):
    ...
    tl_meter = util.AverageMeter()  # total loss
    ...
    with torch.no_grad(), \
        ...
        for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids in data_loader:
            ...
            tl_meter.update(nll_loss.item() + bce_loss.item(), batch_size)
