...
def get_train_args():
    ...
    parser.add_argument('--metric_name',
                        type=str,
                        default='F1',
                        choices=('NLL', 'EM', 'F1', 'BCE', 'NLL_BCE', 'AvNA'),
    ...
    if args.metric_name in ('NLL', 'BCE', 'NLL_BCE'):
        # Best checkpoint is the one that minimizes negative log-likelihood
        args.maximize_metric = False
    elif args.metric_name in ('EM', 'F1', 'AvNA'):
...
def get_retro_test_args():
    """Get arguments needed in run_tav.py for retro-reader."""
    parser = argparse.ArgumentParser('Test a trained model on SQuAD')
    ...
    parser.add_argument('--threshold',
                        type=float,
                        default='0.0',
                        help='Threshold for TAV.')
    parser.add_argument('--load_sketchy_path',
                        type=str,
                        required=True,
                        help='Trained model path for Sketchy Reader.')
    parser.add_argument('--load_intensive_path',
                        type=str,
                        required=True,
                        help='Trained model path for Intensive Reader.')
...
def add_weights_args(parser):
    """Add arguments common to train.py and test.py"""
    parser.add_argument('--alpha1',
                        type=float,
                        default=0.5,
                        help='Alpha_1 for Intensive Reader.')
    parser.add_argument('--alpha2',
                        type=float,
                        default=0.5,
                        help='Alpha_2 for Intensive Reader.')
    parser.add_argument('--beta1',
                        type=float,
                        default=0.5,
                        help='Beta_1 for Rear Verification.')
    parser.add_argument('--beta2',
                        type=float,
                        default=0.5,
                        help='Beta_2 for Rear Verification.')
    parser.add_argument('--lambda1',
                        type=float,
                        default=0.5,
                        help='Alpha_1 for TAV (Threshold-based Answerable Verification).')
    parser.add_argument('--lambda2',
                        type=float,
                        default=0.5,
                        help='Lambda_2 for TAV (Threshold-based Answerable Verification).')
