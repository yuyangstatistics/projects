"""Tune the threshold parameter for TAV.
"""
...
def main(args):
    ...
    for threshold in np.linspace(-0.1, 0.1, num=50):
        log.info(f"Evaluating using threshold={threshold}...")
